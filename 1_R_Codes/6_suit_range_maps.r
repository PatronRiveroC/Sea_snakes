...
for(i in 1:49){
	setwd("D:/Disco_D/SSnks_Var_Therm/Submission/Diversity/9_Model_medians/5m/suit")
	s_5 <- raster(list.files(pattern = ".tif")[i])
	setwd("D:/Disco_D/SSnks_Var_Therm/Submission/Diversity/9_Model_medians/5m/Range")
	r_5 <- raster(list.files(pattern = ".tif")[i])
	setwd("D:/Disco_D/SSnks_Var_Therm/Submission/Diversity/9_Model_medians/10m/suit")
	s_10 <- raster(list.files(pattern = ".tif")[i])
	setwd("D:/Disco_D/SSnks_Var_Therm/Submission/Diversity/9_Model_medians/10m/Range")
