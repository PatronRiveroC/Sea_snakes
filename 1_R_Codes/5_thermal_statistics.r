...
base <- read.csv("D:/6_Inputs/5_spp.csv")
...
for (i in 1:length(raster_names)) {
	assign(raster_names[i], raster(paste0("D:/6_Inputs/8_Tem/5m/", 
	raster_names[i], ".tif")))
}
...
write.csv(df_wide, "D:/6_Inputs/8_Tem/lin_5_stats.csv", row.names = FALSE)
...
for (i in 1:length(raster_names)) {
	assign(raster_names[i], raster(paste0("D:/6_Inputs/8_Tem/10m/", 
	raster_names[i], ".tif")))
}
...
write.csv(df_wide, "D:/6_Inputs/8_Tem/lin_10_stats.csv", row.names = FALSE)
...
write.csv(df_wide, "D:/6_Inputs/8_Tem/Hyd_5_stats.csv", row.names = FALSE)
...
write.csv(df_wide, "D:/6_Inputs/8_Tem/Lat_5_stats.csv", row.names = FALSE)
...
write.csv(df_wide, "D:/6_Inputs/8_Tem/Hyd_10_stats.csv", row.names = FALSE)
...
write.csv(df_wide, "D:/6_Inputs/8_Tem/Lat_10_stats.csv", row.names = FALSE)
...
write.csv(df_wide, "D:/6_Inputs/8_Tem/Aip_5_stats.csv", row.names = FALSE)
...
write.csv(df_wide, "D:/6_Inputs/8_Tem/Emy_5_stats.csv", row.names = FALSE)
...
write.csv(df_wide, "D:/6_Inputs/8_Tem/Aip_10_stats.csv", row.names = FALSE)
...
write.csv(df_wide, "D:/6_Inputs/8_Tem/Emy_10_stats.csv", row.names = FALSE)
