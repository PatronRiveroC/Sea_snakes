...
base <- read.csv("D:/2_Inputs/5_spp.csv")
...
for (i in 1:length(raster_names)) {
	assign(raster_names[i], raster(paste0("D:/5m/", 
	raster_names[i], ".tif")))
}
...
write.csv(df_wide, "D:/lin_5_stats.csv", row.names = FALSE)
...
for (i in 1:length(raster_names)) {
	assign(raster_names[i], raster(paste0("D:/10m/", 
	raster_names[i], ".tif")))
}
...
write.csv(df_wide, "D:/lin_10_stats.csv", row.names = FALSE)
...
write.csv(df_wide, "D:/Hyd_5_stats.csv", row.names = FALSE)
...
write.csv(df_wide, "D:/Lat_5_stats.csv", row.names = FALSE)
...
write.csv(df_wide, "D:/Hyd_10_stats.csv", row.names = FALSE)
...
write.csv(df_wide, "D:/Lat_10_stats.csv", row.names = FALSE)
...
write.csv(df_wide, "D:/Aip_5_stats.csv", row.names = FALSE)
...
write.csv(df_wide, "D:/Emy_5_stats.csv", row.names = FALSE)
...
write.csv(df_wide, "D:/Aip_10_stats.csv", row.names = FALSE)
...
write.csv(df_wide, "D:/Emy_10_stats.csv", row.names = FALSE)
...
setwd("D:/2_Figures")
ggsave(file = "Fig3X_Therm_1000_dpi.jpeg", plot = Final, width = 30, height = 60, dpi = 1000, units = "cm", device = "jpeg")
ggsave(file = "Fig3X_Therm_1000_dpi.pdf", plot = Final, width = 30, height = 60, dpi = 2000, units = "cm", device = "pdf")
