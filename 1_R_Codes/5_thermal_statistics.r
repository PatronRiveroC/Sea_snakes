...
Lat_10 <- subset(All_10, Especie == "Lat_col" | Especie == "Lat_cro" | Especie == "Lat_fro" | 
			    Especie == "Lat_lat" | Especie == "Lat_sai" | Especie == "Lat_sem")
Hyd_10 <- subset(All_10, !(Especie %in% Lat_5$Especie))
...
Eph_5 <- subset(All_5, Especie == "Eph_gra")

Eph_10 <- subset(All_10, Especie == "Eph_gra")
...
ggsave(file = "Fig3_Therm_1000_dpi.jpeg", plot = Final, width = 30, height = 60, dpi = 1000, units = "cm", device = "jpeg")
ggsave(file = "Fig3_Therm_1000_dpi.pdf", plot = Final, width = 30, height = 60, dpi = 2000, units = "cm", device = "pdf")
