...
base <- read.csv("D:/1_Ssnks/2_Inputs/5_spp.csv")
...
for (i in 1:length(raster_names)) {
	assign(raster_names[i], raster(paste0("D:/1_Ssnks/5m/", 
	raster_names[i], ".tif")))
}
...
write.csv(df_wide, "D:/1_Ssnks/lin_5_stats.csv", row.names = FALSE)
...
for (i in 1:length(raster_names)) {
	assign(raster_names[i], raster(paste0("D:/1_Ssnks/10m/", 
	raster_names[i], ".tif")))
}
...
write.csv(df_wide, "D:/1_Ssnks/lin_10_stats.csv", row.names = FALSE)
...
Lat_5 <- subset(All_5, Species == "Lat_col" | Species == "Lat_cro" | Species == "Lat_fro" | 
			    Species == "Lat_lat" | Species == "Lat_sai" | Species == "Lat_sem")
...
write.csv(df_wide, "D:/1_Ssnks/Hyd_5_stats.csv", row.names = FALSE)
...
write.csv(df_wide, "D:/1_Ssnks/Lat_5_stats.csv", row.names = FALSE)
...
write.csv(df_wide, "D:/1_Ssnks/Hyd_10_stats.csv", row.names = FALSE)
...
write.csv(df_wide, "D:/1_Ssnks/Lat_10_stats.csv", row.names = FALSE)
...
Lat_10 <- subset(All_10, Species == "Lat_col" | Species == "Lat_cro" | Species == "Lat_fro" | 
			    Species == "Lat_lat" | Species == "Lat_sai" | Species == "Lat_sem")
Hyd_10 <- subset(All_10, !(Species %in% Lat_5$Species))
...
Aip_5 <- subset(All_5, Species == "Aip_apr" | Species == "Aip_dub" | Species == "Aip_eyd" | 
			    Species == "Aip_fol" | Species == "Aip_fus" | Species == "Aip_lae" |
				Species == "Aip_mos" | Species == "Aip_poo" | Species == "Aip_ten")

Aip_10 <- subset(All_10, Species == "Aip_apr" | Species == "Aip_dub" | Species == "Aip_eyd" | 
			    Species == "Aip_fol" | Species == "Aip_fus" | Species == "Aip_lae" |
				Species == "Aip_mos" | Species == "Aip_poo" | Species == "Aip_ten")

Emy_5 <- subset(All_5, Species == "Emy_ann" | Species == "Emy_iji")

Emy_10 <- subset(All_10, Species == "Emy_ann" | Species == "Emy_iji")

Eph_5 <- subset(All_5, Species == "Eph_gra")

Eph_10 <- subset(All_10, Species == "Eph_gra")
...
Mic_5 <- subset(All_5, Species == "Mic_gra")

Mic_10 <- subset(All_10, Species == "Mic_gra")

all_5 <- rbind(Aip_5, Emy_5, Eph_5, Lat_5, Mic_5)

all_10 <- rbind(Aip_10, Emy_10, Eph_10, Lat_10, Mic_10)
...
check_normality_and_test_Tem(Eph_10)
check_normality_and_test_Tem(Hyd_10)
...
check_normality_and_test_Set(Eph_10)
check_normality_and_test_Set(Hyd_10)
...
write.csv(df_wide, "D:/1_Ssnks/Aip_5_stats.csv", row.names = FALSE)
...
write.csv(df_wide, "D:/1_Ssnks/Emy_5_stats.csv", row.names = FALSE)
...
write.csv(df_wide, "D:/1_Ssnks/Aip_10_stats.csv", row.names = FALSE)
...
write.csv(df_wide, "D:/1_Ssnks/Emy_10_stats.csv", row.names = FALSE)
...
ggsave(file = "Fig_3.tiff", plot = Final, width = 25, height = 40, dpi = 450, units = "cm", device = "tiff")
ggsave(file = "Fig_3.pdf", plot = Final, width = 25, height = 40, dpi = 450, units = "cm", device = "pdf")
