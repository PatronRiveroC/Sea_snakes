...
data <- read_and_clean_data("D:/Disco_D/SSnks_Var_Therm/Submission/Diversity/6_Inputs/1_raw_PC_PI_5.csv",
					"D:/Disco_D/SSnks_Var_Therm/Submission/Diversity/6_Inputs/2_raw_PC_PI_10.csv")
...
setwd("D:/Disco_D/SSnks_Var_Therm/Submission/Diversity/6_Inputs")
