...
data <- read_and_clean_data("D:/1_Ssnks/2_Inputs/1_raw_PC_PI_5.csv",
					"D:/1_Ssnks/2_Inputs/2_raw_PC_PI_10.csv")
...
setwd("D:/1_Ssnks/2_Inputs")
write.csv(PC, "6X_comparison_results_PC.csv", row.names = FALSE)
write.csv(PI, "7X_comparison_results_PI.csv", row.names = FALSE)
