...
data_5 <- read.csv("D:/2_Inputs/1_raw_PC_PI_5.csv")
...
data_10 <- read.csv("D:/2_Inputs/2_raw_PC_PI_10.csv")
...
setwd("D:/2_Figures")
ggsave(file = "Fig1_var_import_2000_dpi.jpeg", plot = p4, width = 28, height = 30, dpi = 2000, units = "cm", device = "jpeg")
ggsave(file = "Fig1_var_import_2000_dpi.pdf", plot = p4, width = 28, height = 30, dpi = 2000, units = "cm", device = "pdf")
...
data1 <- load_data("D:/2_Inputs/1_raw_PC_PI_5.csv")
data2 <- load_data("D:/2_Inputs/2_raw_PC_PI_10.csv")
