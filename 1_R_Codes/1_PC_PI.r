...
data_5 <- read.csv("D:/6_Inputs/1_raw_PC_PI_5.csv")
med_5 <- calc_median(data_5)
write.csv(med_5, "D:/6_Inputs/3_PC_PI_5.csv", row.names = FALSE)
...
data_10 <- read.csv("D:/6_Inputs/2_raw_PC_PI_10.csv")
med_10 <- calc_median(data_10)
write.csv(med_10, "D:/6_Inputs/4_PC_PI_10.csv", row.names = FALSE)
...
setwd("D:/SSnks_Var_Therm/Submission/Diversity")
...
data1 <- load_data("D:/6_Inputs/1_raw_PC_PI_5.csv")
data2 <- load_data("D:/6_Inputs/2_raw_PC_PI_10.csv")
